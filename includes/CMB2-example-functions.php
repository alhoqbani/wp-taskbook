 ...
 */
function taskbook_show_if_front_page( $cmb ) {
 ...
 * @return bool              True if metabox should show
 */
function taskbook_hide_if_no_cats( $field ) {
 ...
 */
function taskbook_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function taskbook_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field $field      Field object.
 */
function taskbook_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'taskbook_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function taskbook_register_demo_metabox() {
	$prefix = 'taskbook_demo_';
	...
	$cmb_demo = new_cmb2_box( array(
		...
		// 'show_on_cb' => 'taskbook_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'taskbook_add_some_classes', // Add classes through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'taskbook_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'taskbook_display_text_small_column', // Output the display of the column values through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 'taskbook_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'taskbook_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'taskbook_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function taskbook_register_about_page_metabox() {
	$prefix = 'taskbook_about_';
...
add_action( 'cmb2_admin_init', 'taskbook_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function taskbook_register_repeatable_group_field_metabox() {
	$prefix = 'taskbook_group_';
...
add_action( 'cmb2_admin_init', 'taskbook_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function taskbook_register_user_profile_metabox() {
	$prefix = 'taskbook_user_';
...
add_action( 'cmb2_admin_init', 'taskbook_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function taskbook_register_taxonomy_metabox() {
	$prefix = 'taskbook_term_';
...
add_action( 'cmb2_admin_init', 'taskbook_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function taskbook_register_theme_options_metabox() {

	/**
	 * Registers options page menu item and form.
	 */
	$cmb_options = new_cmb2_box( array(
		'id'           => 'taskbook_theme_options_page',
		...
		'option_key'      => 'taskbook_theme_options', // The option key and admin menu page slug.
		...
		// 'message_cb'      => 'taskbook_options_page_message_callback',
	) );
 ...
 * }
 */
function taskbook_options_page_message_callback( $cmb, $args ) {
